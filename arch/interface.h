...
#define ADDRESS_GRAPHICS_CARD_DATA	(0x00000010)
#define ADDRESS_GRAPHICS_CARD_ADDRESS	(0x00000013)
...
#define XMACRO_SUBINSTRUCTIONS(x)	\
	X(SINSTR_NOP)			\
	X(SINSTR_BRK)			\
	X(SINSTR_LDR_IMMIDIATE)		\
	X(SINSTR_LDR_REG)		\
	X(SINSTR_LDR_ABS)		\
	X(SINSTR_LDR_ABS_PTR)		\
	X(SINSTR_LDR_ABS_IDX)		\
	X(SINSTR_LDR_ABS_PTR_IDX)	\
	X(SINSTR_LDR_ABS_PTR_OFF)	\
	X(SINSTR_LDR_ZP_PTR)		\
	X(SINSTR_LDR_ZP_OFF)		\
	X(SINSTR_LDR_ZP_IDX)		\
	X(SINSTR_LDRB_IMMIDIATE)	\
	X(SINSTR_LDRB_REG)		\
	X(SINSTR_LDRB_ABS)		\
	X(SINSTR_LDRB_ABS_PTR)		\
	X(SINSTR_LDRB_ABS_IDX)		\
	X(SINSTR_LDRB_ABS_PTR_IDX)	\
	X(SINSTR_LDRB_ABS_PTR_OFF)	\
	X(SINSTR_LDRB_ZP_PTR)		\
	X(SINSTR_LDRB_ZP_OFF)		\
	X(SINSTR_LDRB_ZP_IDX)		\
	X(SINSTR_LDRW_ABS)		\
	X(SINSTR_LDRW_ABS_PTR)		\
	X(SINSTR_LDRW_ABS_IDX)		\
	X(SINSTR_LDRW_ABS_PTR_IDX)	\
	X(SINSTR_LDRW_ABS_PTR_OFF)	\
	X(SINSTR_LDRW_ZP_PTR)		\
	X(SINSTR_LDRW_ZP_OFF)		\
	X(SINSTR_LDRW_ZP_IDX)		\
	X(SINSTR_STR_ABS)		\
	X(SINSTR_STR_ABS_PTR)		\
	X(SINSTR_STR_ABS_IDX)		\
	X(SINSTR_STR_ABS_PTR_IDX)	\
	X(SINSTR_STR_ABS_PTR_OFF)	\
	X(SINSTR_STR_ZP_PTR)		\
	X(SINSTR_STR_ZP_OFF)		\
	X(SINSTR_STR_ZP_IDX)		\
	X(SINSTR_STRB_ABS)		\
	X(SINSTR_STRB_ABS_PTR)		\
	X(SINSTR_STRB_ABS_IDX)		\
	X(SINSTR_STRB_ABS_PTR_IDX)	\
	X(SINSTR_STRB_ABS_PTR_OFF)	\
	X(SINSTR_STRB_ZP_PTR)		\
	X(SINSTR_STRB_ZP_OFF)		\
	X(SINSTR_STRB_ZP_IDX)		\
	X(SINSTR_CPRP)			\
	X(SINSTR_BZ)			\
	X(SINSTR_BNZ)			\
	X(SINSTR_BCC)			\
	...
	X(SINSTR_BRA)			\
	X(SINSTR_LBRA_ABS)		\
	X(SINSTR_LBRA_ABS_PTR)		\
	X(SINSTR_CALL_ABS)		\
	X(SINSTR_CALL_ABS_PTR)		\
	X(SINSTR_CALL_ZP_PTR)		\
	X(SINSTR_RET)			\
	X(SINSTR_RTI)			\
	X(SINSTR_ADC_IMMIDIATE)		\
	X(SINSTR_ADC_REG)		\
	X(SINSTR_ADC_ABS)		\
	X(SINSTR_ADC_ABS_PTR)		\
	X(SINSTR_ADC_ABS_IDX)		\
	X(SINSTR_ADC_ABS_PTR_IDX)	\
	X(SINSTR_ADC_ABS_PTR_OFF)	\
	X(SINSTR_ADC_ZP_PTR)		\
	X(SINSTR_ADC_ZP_OFF)		\
	X(SINSTR_ADC_ZP_IDX)		\
	X(SINSTR_ADD_IMMIDIATE)		\
	X(SINSTR_ADD_REG)		\
	X(SINSTR_ADD_ABS)		\
	X(SINSTR_ADD_ABS_PTR)		\
	X(SINSTR_ADD_ABS_IDX)		\
	X(SINSTR_ADD_ABS_PTR_IDX)	\
	X(SINSTR_ADD_ABS_PTR_OFF)	\
	X(SINSTR_ADD_ZP_PTR)		\
	X(SINSTR_ADD_ZP_OFF)		\
	X(SINSTR_ADD_ZP_IDX)		\
	X(SINSTR_ADCW_IMMIDIATE)	\
	X(SINSTR_ADCW_REG)		\
	X(SINSTR_ADCW_ABS)		\
	X(SINSTR_ADCW_ABS_PTR)		\
	X(SINSTR_ADCW_ABS_IDX)		\
	X(SINSTR_ADCW_ABS_PTR_IDX)	\
	X(SINSTR_ADCW_ABS_PTR_OFF)	\
	X(SINSTR_ADCW_ZP_PTR)		\
	X(SINSTR_ADCW_ZP_OFF)		\
	X(SINSTR_ADCW_ZP_IDX)		\
	X(SINSTR_ADDW_IMMIDIATE)	\
	X(SINSTR_ADDW_REG)		\
	X(SINSTR_ADDW_ABS)		\
	X(SINSTR_ADDW_ABS_PTR)		\
	X(SINSTR_ADDW_ABS_IDX)		\
	X(SINSTR_ADDW_ABS_PTR_IDX)	\
	X(SINSTR_ADDW_ABS_PTR_OFF)	\
	X(SINSTR_ADDW_ZP_PTR)		\
	X(SINSTR_ADDW_ZP_OFF)		\
	X(SINSTR_ADDW_ZP_IDX)		\
	X(SINSTR_SBC_IMMIDIATE)		\
	X(SINSTR_SBC_REG)		\
	X(SINSTR_SBC_ABS)		\
	X(SINSTR_SBC_ABS_PTR)		\
	X(SINSTR_SBC_ABS_IDX)		\
	X(SINSTR_SBC_ABS_PTR_IDX)	\
	X(SINSTR_SBC_ABS_PTR_OFF)	\
	X(SINSTR_SBC_ZP_PTR)		\
	X(SINSTR_SBC_ZP_OFF)		\
	X(SINSTR_SBC_ZP_IDX)		\
	X(SINSTR_SUB_IMMIDIATE)		\
	X(SINSTR_SUB_REG)		\
	X(SINSTR_SUB_ABS)		\
	X(SINSTR_SUB_ABS_PTR)		\
	X(SINSTR_SUB_ABS_IDX)		\
	X(SINSTR_SUB_ABS_PTR_IDX)	\
	X(SINSTR_SUB_ABS_PTR_OFF)	\
	X(SINSTR_SUB_ZP_PTR)		\
	X(SINSTR_SUB_ZP_OFF)		\
	X(SINSTR_SUB_ZP_IDX)		\
	X(SINSTR_SBCW_IMMIDIATE)	\
	X(SINSTR_SBCW_REG)		\
	X(SINSTR_SBCW_ABS)		\
	X(SINSTR_SBCW_ABS_PTR)		\
	X(SINSTR_SBCW_ABS_IDX)		\
	X(SINSTR_SBCW_ABS_PTR_IDX)	\
	X(SINSTR_SBCW_ABS_PTR_OFF)	\
	X(SINSTR_SBCW_ZP_PTR)		\
	X(SINSTR_SBCW_ZP_OFF)		\
	X(SINSTR_SBCW_ZP_IDX)		\
	X(SINSTR_SUBW_IMMIDIATE)	\
	X(SINSTR_SUBW_REG)		\
	X(SINSTR_SUBW_ABS)		\
	X(SINSTR_SUBW_ABS_PTR)		\
	X(SINSTR_SUBW_ABS_IDX)		\
	X(SINSTR_SUBW_ABS_PTR_IDX)	\
	X(SINSTR_SUBW_ABS_PTR_OFF)	\
	X(SINSTR_SUBW_ZP_PTR)		\
	X(SINSTR_SUBW_ZP_OFF)		\
	X(SINSTR_SUBW_ZP_IDX)		\
	X(SINSTR_EOR_IMMIDIATE)		\
	X(SINSTR_EOR_REG)		\
	X(SINSTR_EOR_ABS)		\
	X(SINSTR_EOR_ABS_PTR)		\
	X(SINSTR_EOR_ABS_IDX)		\
	X(SINSTR_EOR_ABS_PTR_IDX)	\
	X(SINSTR_EOR_ABS_PTR_OFF)	\
	X(SINSTR_EOR_ZP_PTR)		\
	X(SINSTR_EOR_ZP_OFF)		\
	X(SINSTR_EOR_ZP_IDX)		\
	X(SINSTR_ORR_IMMIDIATE)		\
	X(SINSTR_ORR_REG)		\
	X(SINSTR_ORR_ABS)		\
	X(SINSTR_ORR_ABS_PTR)		\
	X(SINSTR_ORR_ABS_IDX)		\
	X(SINSTR_ORR_ABS_PTR_IDX)	\
	X(SINSTR_ORR_ABS_PTR_OFF)	\
	X(SINSTR_ORR_ZP_PTR)		\
	X(SINSTR_ORR_ZP_OFF)		\
	X(SINSTR_ORR_ZP_IDX)		\
	X(SINSTR_AND_IMMIDIATE)		\
	X(SINSTR_AND_REG)		\
	X(SINSTR_AND_ABS)		\
	X(SINSTR_AND_ABS_PTR)		\
	X(SINSTR_AND_ABS_IDX)		\
	X(SINSTR_AND_ABS_PTR_IDX)	\
	X(SINSTR_AND_ABS_PTR_OFF)	\
	X(SINSTR_AND_ZP_PTR)		\
	X(SINSTR_AND_ZP_OFF)		\
	X(SINSTR_AND_ZP_IDX)		\
	X(SINSTR_CMP_IMMIDIATE)		\
	X(SINSTR_CMP_REG)		\
	X(SINSTR_CMP_ABS)		\
	X(SINSTR_CMP_ABS_PTR)		\
	X(SINSTR_CMP_ABS_IDX)		\
	X(SINSTR_CMP_ABS_PTR_IDX)	\
	X(SINSTR_CMP_ABS_PTR_OFF)	\
	X(SINSTR_CMP_ZP_PTR)		\
	X(SINSTR_CMP_ZP_OFF)		\
	X(SINSTR_CMP_ZP_IDX)		\
	X(SINSTR_ASR)			\
	...
	X(SINSTR_INC)			\
	X(SINSTR_INCW)			\
	X(SINSTR_CRB_IMMIDIATE)		\
	X(SINSTR_CRB_REG)		\
	X(SINSTR_CRB_ABS)		\
	X(SINSTR_CRB_ABS_PTR)		\
	X(SINSTR_CRB_ABS_IDX)		\
	X(SINSTR_CRB_ABS_PTR_IDX)	\
	X(SINSTR_CRB_ABS_PTR_OFF)	\
	X(SINSTR_CRB_ZP_PTR)		\
	X(SINSTR_CRB_ZP_OFF)		\
	X(SINSTR_CRB_ZP_IDX)		\
	X(SINSTR_SRB_IMMIDIATE)		\
	X(SINSTR_SRB_REG)		\
	X(SINSTR_SRB_ABS)		\
	X(SINSTR_SRB_ABS_PTR)		\
	X(SINSTR_SRB_ABS_IDX)		\
	X(SINSTR_SRB_ABS_PTR_IDX)	\
	X(SINSTR_SRB_ABS_PTR_OFF)	\
	X(SINSTR_SRB_ZP_PTR)		\
	X(SINSTR_SRB_ZP_OFF)		\
	X(SINSTR_SRB_ZP_IDX)jwd
